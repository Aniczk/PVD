...
def download_files(protein_list, organism_name,temp_dir):
...
def prepare():
    ...
    try:
        ...
        print("Utworzono katalog tymczasowy")
...
def list_of_proteins(protein_list, organism_name):
    temp_dir = prepare()
    download_files(protein_list, organism_name, temp_dir)
